...
Gem::Specification.new do |spec|
  ...
  # spec.add_development_dependency 'frest-core', path: '../frest-core'
  # spec.add_development_dependency 'frest-rich_function', path: '../frest-rich_function'
  # spec.add_development_dependency 'frest-directory_store', path: '../frest-directory_store'
end
